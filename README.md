...
Co-occurence network analysis was performed using [Spiec Easi](https://github.com/zdk123/SpiecEasi) with [scprit](https://github.com/Jia-Xiu/coalescence_project/blob/main/com_analysis_scripts/Network_Spiec_Easi_species_validation.Rmd). I did further plotting in R with a Fruchterman–Reingold layout, you can find the script [here](https://github.com/Jia-Xiu/coalescence_project/blob/main/com_analysis_scripts/Network_Spiec_Easi_species_plotting.Rmd). 

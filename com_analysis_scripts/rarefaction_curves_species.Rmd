---
title: "Rarefaction curves at species level"
...
mytheme <- theme_light()+
  theme(text = element_text(size = 10),
        ...
        panel.grid.major = element_blank(), #element_line(colour = "grey70", linewidth = 0.1),
        panel.grid.minor = element_blank())  
```


### Rarefaction curves at species level

```{r}

# read phyloseq object from all the samples - raw reads
ps_rawreads_species <- readRDS("phyloseq_object_species_rawreads.rds")

otu_table_all <- as.data.frame(otu_table(ps_rawreads_species)) 
...
# ggsave("Fig_S4_rarefaction_curves_species.pdf", width = 6, height = 7, p)
# ggsave("Fig_S4_rarefaction_curves_species.png", width = 6, height = 7, p)
